...
const Settings = () => {
  ...
  const handleCountryChange = (country) => {
    ...
    // Set first city of new country as default
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <h1 className="font-playfair text-2xl font-bold text-stone-800 flex items-center gap-2">
      ...
      {/* Language Settings */}
      <motion.div variants={itemVariants}>
        <Card className="border-stone-200" data-testid="language-settings">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <span className={`text-sm font-medium ${language === 'de' ? 'text-emerald-600' : 'text-stone-400'}`}>
                  DE
                </span>
                <Switch
                  checked={language === 'tr'}
                ...
                />
                <span className={`text-sm font-medium ${language === 'tr' ? 'text-emerald-600' : 'text-stone-400'}`}>
                  TR
                </span>
              </div>
            </div>
      ...
      {/* Location Settings */}
      <motion.div variants={itemVariants}>
        <Card className="border-stone-200" data-testid="location-settings">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg">
          ...
          <CardContent className="space-y-4">
            {/* Country Selection */}
            <div>
              <Label className="text-sm text-stone-600 mb-2 block">{t('settings.country')}</Label>
            ...
            {/* City Selection */}
            <div>
              <Label className="text-sm text-stone-600 mb-2 block">{t('settings.selectCity')}</Label>
      ...
      {/* About */}
      <motion.div variants={itemVariants}>
        <Card className="border-stone-200" data-testid="about-settings">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-stone-100">
                <span className="text-stone-600">{t('settings.version')}</span>
